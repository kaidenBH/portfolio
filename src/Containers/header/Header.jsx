  ...
  return (
    <div className='haitem_header section_padding' id='home'>
      <div className='haitem_header-content'>
        ...
        <p>I am a Full Stack Developer. I'm skilled in HTML/CSS, JavaScript , Python, C#. 
            I have Strong Problem solivng skills. And i have a Master's degree of Artificial Intelligent.</p>
